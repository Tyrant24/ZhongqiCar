...
export class InstApi{
    ...
    bangzhulist(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/bangzhulist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    jialiulan(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/jialiulan',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    memberlevel(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/memberlevel',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    qrcode(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/qrcode',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
